...
function NS.CoreUI.BuildBars()
    ...
    for k = 1, NS.Options.Bars.MaxNumBars do
        ...
        --: Name
        NS.CoreUI.Bar[k].Name = NS.CoreUI.Bar[k].Name or NS.CoreUI.Bar[k]:CreateFontString(nil, "ARTWORK", nil)
        ...
        --: Level
        NS.CoreUI.Bar[k].Level = NS.CoreUI.Bar[k].Level or NS.CoreUI.Bar[k]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
        ...
        --: Guild
        NS.CoreUI.Bar[k].Guild = NS.CoreUI.Bar[k].Guild or NS.CoreUI.Bar[k]:CreateFontString(nil, "ARTWORK", "GameFontNormal")
...
function NS.CoreUI.ButtonPreClick(barID, MouseButton)
    ...
    if playerName then
        if MouseButton == "LeftButton" then
            if not InCombatLockdown() then
		NS.CoreUI.Bar[barID].Button:RegisterForClicks("LeftButtonDown", "RightButtonDown")
